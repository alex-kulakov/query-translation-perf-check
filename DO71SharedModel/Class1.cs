...
namespace DO71SharedModel
{
  ...
  public class QueryRunner
  {
    ...
    public SqlCompilationResult CompileTranslated(QueryBuilder queryBuilder, in QueryTranslationResult translationResult)
    {
      return queryBuilder.CompileQuery(translationResult.Query);
    }

    public QueryRequest CreateRequest(QueryBuilder queryBuilder, SqlCompilationResult compilationResult, IReadOnlyList<QueryParameterBinding> bindings)
    {
      return queryBuilder.CreateRequest(compilationResult, bindings);
    }

    public QueryCommand CreateQueryCommand(QueryBuilder queryBuilder, in QueryRequest request)
    {
